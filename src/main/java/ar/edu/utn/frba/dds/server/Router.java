...
public class Router {
    ...
    public static void init(Javalin app) {
        ...
        app.get("/colaboraciones/donacion-vianda/nuevo", ctx -> ctx.render("colaboraciones/donacion_vianda_crear.hbs"));
        app.get("/colaboraciones/registro-persona-vulnerable/nuevo", ctx -> ctx.render("colaboraciones/registro_pv_crear.hbs"));
        ...
        app.get("/colaboraciones/oferta-producto-servicio/nuevo", ctx -> ctx.render("colaboraciones/oferta_prod_serv_crear.hbs"));
        app.get("/colaboraciones/encargarse-de-heladeras/nuevo", ctx -> ctx.render("colaboraciones/encargarse_de_heladera_crear.hbs"));
