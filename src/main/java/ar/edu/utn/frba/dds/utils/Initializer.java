...
public class Initializer implements WithSimplePersistenceUnit {
  ...
  public void withHeladeras() {
    ...
    Ubicacion u1 = new Ubicacion(-34.6035, -58.383);
    Ubicacion u2 = new Ubicacion(-34.6028, -58.381);
    Ubicacion u3 = new Ubicacion(-34.59861794351904, -58.420114964305405);
    Ubicacion u4 = new Ubicacion(-34.6037, -58.3816);
    Ubicacion u5 = new Ubicacion(-34.6010, -58.3785);
    Ubicacion u6 = new Ubicacion(-34.6025, -58.3795);
    Ubicacion u7 = new Ubicacion(-34.6080, -58.3835);
    Ubicacion u8 = new Ubicacion(-34.6075, -58.3800);
    Ubicacion u9 = new Ubicacion(-34.6090, -58.3860);
    Ubicacion u10 = new Ubicacion(-34.6035, -58.383);
    Ubicacion u11 = new Ubicacion(-34.6058, -58.3805);
    Ubicacion u12 = new Ubicacion(-34.6045, -58.3790);
    Ubicacion u13 = new Ubicacion(-34.6040, -58.3800);
    Ubicacion u14 = new Ubicacion(-34.6060, -58.3845);
    Ubicacion u15 = new Ubicacion(-34.6050, -58.3825);
    ...
    Direccion d3 = new Direccion(b6, c5, 951, u3);
