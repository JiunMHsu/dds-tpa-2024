...
public class SuscripcionRouter implements IRouter {
  ...
  public void apply(RouterConfig config) {
    ...
    config.apiBuilder(() ->
        path("/suscripciones", () -> {
          get("/new", ServiceLocator.instanceOf(SuscripcionHeladeraController.class)::create,
              TipoRol.COLABORADOR);
          ...
          path("/falla-tecnica", () -> {
            ...
            get("/new",
                ServiceLocator.instanceOf(SuscripcionHeladeraController.class)::createFallaHeladera,
                TipoRol.COLABORADOR);
          });
          ...
          path("/falta-viandas", () -> {
            ...
            get("/new",
                ServiceLocator.instanceOf(SuscripcionHeladeraController.class)::createFaltaVianda,
                TipoRol.COLABORADOR);
          });
          ...
          path("/heladera-llena", () -> {
            ...
            get("/new",
                ServiceLocator.instanceOf(SuscripcionHeladeraController.class)::createHeladeraLlena,
                TipoRol.COLABORADOR);
          });
        })
    );
