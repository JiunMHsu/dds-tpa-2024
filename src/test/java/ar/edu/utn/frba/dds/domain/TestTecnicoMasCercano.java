...
//  Tecnico tecnico1 = Tecnico.con("1", Contacto.empty(), new Area(new Ubicacion(-34.615803, -58.433298), 9.0));
//  Tecnico tecnico2 = Tecnico.con("2", Contacto.empty(), new Area(new Ubicacion(-34.615803, -58.433298), 6.0));
//  Tecnico tecnico3 = Tecnico.con("3", Contacto.empty(), new Area(new Ubicacion(-31.420083, -64.188776), 5.0));
//
//  Heladera heladera = Heladera.con("", Direccion.con(new Calle(""), 0, new Ubicacion(-34.603722, -58.381592)), 70);
//
//  @Test
