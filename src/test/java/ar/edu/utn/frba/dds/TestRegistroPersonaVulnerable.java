...
public class TestRegistroPersonaVulnerable {
//
//  @Test
...
//    Direccion direccionTest = Direccion.with(new Calle("Aguero"), 1281, ubicacionTest);
...
//
//    // Resgistro
//    TarjetaPersonaVulnerable tarjeta = TarjetaPersonaVulnerable.with(GeneradorDeCodigosTarjeta.generar());
